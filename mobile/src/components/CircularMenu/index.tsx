...
export function CircularMenu({ onTransactionsPress }: CircularMenuProps) {
  return (
    <VStack alignItems="center" mt="$6" mb="$4">
          ...
          <VStack alignItems="center" space="sm">
            ...
            >
              ...
              <VStack space="xs" alignItems="flex-end">
                <Box width="$2" height="$2" bg="$white" borderRadius="$sm" />
                <Box width="$3" height="$3" bg="$white" borderRadius="$sm" />
                <Box width="$1" height="$1" bg="$white" borderRadius="$sm" />
              </VStack>
            </Box>
